...
function calculatedSum() {
    ...
    const websiteReseptiont = document.querySelector('#calculator-form-input-reception input:checked');

    //Values
    const websiteCartValue = convertCartOptionToPrice(websiteCart.value);
    const websiteReseptiontValue = convertReceptionOptionToPrice(websiteReseptiont.value);
